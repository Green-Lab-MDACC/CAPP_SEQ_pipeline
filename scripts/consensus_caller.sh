...
do
    ...
    FIRST_FASTQ=$WORKING_DIR/data/$SAMPLE_ID/FASTQ/${SAMPLE_ID_R1}.fastq.gz
    SECOND_FASTQ=$WORKING_DIR/data/$SAMPLE_ID/FASTQ/${SAMPLE_ID_R2}.fastq.gz

    #CREATE DIRECTORY FOR SAVING OUTPUTS
    mkdir $WORKING_DIR/data/$SAMPLE_ID/$SAMPLE_NAME
    mkdir $WORKING_DIR/data/$SAMPLE_ID/$SAMPLE_NAME/$CONSENSUS

    #ASSIGN OUTPUT FILE PATHS AND NAMES
    FGBIO_FASTQTOBAM_OUT=$WORKING_DIR/data/$SAMPLE_ID/$SAMPLE_NAME/$CONSENSUS/${SAMPLE_NAME}.ubam.bam
    FGBIO_FASTQTOBAM_EXTRACTED_OUT=$WORKING_DIR/data/$SAMPLE_ID/$SAMPLE_NAME/$CONSENSUS/${SAMPLE_NAME}.ubam.umi.extracted.bam
    PICARD_SAMTOFASTQ_OUT=$WORKING_DIR/data/$SAMPLE_ID/$SAMPLE_NAME/$CONSENSUS/${SAMPLE_NAME}.ubam.umi.extracted.fastq
    BWA_TEMP_SAM=$WORKING_DIR/data/$SAMPLE_ID/$SAMPLE_NAME/$CONSENSUS/${SAMPLE_NAME}.ubam.aligned.sam
    BWA_TEMP_SAM_2=$WORKING_DIR/data/$SAMPLE_ID/$SAMPLE_NAME/$CONSENSUS/${SAMPLE_NAME}.ubam.aligned_2.sam
    PICARD_MERGEBAMALIGNMENT_OUT=$WORKING_DIR/data/$SAMPLE_ID/$SAMPLE_NAME/$CONSENSUS/${SAMPLE_NAME}.ubam.umi.extracted.aligned.bam
    FGBIO_GROUPED_OUT=$WORKING_DIR/data/$SAMPLE_ID/$SAMPLE_NAME/$CONSENSUS/${SAMPLE_NAME}.ubam.umi.extracted.aligned.grouped.bam
    FGBIO_GROUPED_OUT_METRICS=$WORKING_DIR/data/$SAMPLE_ID/$SAMPLE_NAME/$CONSENSUS/${SAMPLE_NAME}.ubam.umi.extracted.aligned.grouped.txt
    UMI_CALLS_FAMILY_HISTOGRAM=$WORKING_DIR/data/$SAMPLE_ID/$SAMPLE_NAME/$CONSENSUS/${SAMPLE_NAME}.umi_calls.histogram.csv
    FGBIO_CALLDUPLEXCONSENSUS_GROUPED_OUT=$WORKING_DIR/data/$SAMPLE_ID/$SAMPLE_NAME/$CONSENSUS/${SAMPLE_NAME}.ubam.umi.extracted.aligned.grouped.umicalled.bam
    FGBIO_CALLDUPLEXCONSENSUS_GROUPED_OUT_METRICS=$WORKING_DIR/data/$SAMPLE_ID/$SAMPLE_NAME/$CONSENSUS/${SAMPLE_NAME}.ubam.umi.extracted.aligned.grouped.umicalled.metrics.txt
    BAITS=$WORKING_DIR/data/pan00309.merged.baits.hs38DH.interval_list
    TARGETS=$WORKING_DIR/data/pan00309.targets.hs38DH.interval_list
    PICARD_SAMTOFASTQ_CALLDUPLEXCONSENSUS_OUT=$WORKING_DIR/data/$SAMPLE_ID/$SAMPLE_NAME/$CONSENSUS/${SAMPLE_NAME}.ubam.umi.extracted.aligned.grouped.umicalled.fastq
    PICARD_SAMTOFASTQ_CALLDUPLEXCONSENSUS_MAPPED_OUT=$WORKING_DIR/data/$SAMPLE_ID/$SAMPLE_NAME/$CONSENSUS/${SAMPLE_NAME}.ubam.umi.extracted.aligned.grouped.umicalled.mapped.bam
    GATK_REALIGNTARGETS=$WORKING_DIR/data/$SAMPLE_ID/$SAMPLE_NAME/$CONSENSUS/${SAMPLE_NAME}.ubam.umi.extracted.aligned.grouped.umicalled.mapped.realigntargets.intervals
    GATK_REALIGNEDBAM=$WORKING_DIR/data/$SAMPLE_ID/$SAMPLE_NAME/$CONSENSUS/${SAMPLE_NAME}.ubam.umi.extracted.aligned.grouped.umicalled.mapped.realigned.bam
    GATK_REALIGNTARGETSFILT=$WORKING_DIR/data/$SAMPLE_ID/$SAMPLE_NAME/$CONSENSUS/${SAMPLE_NAME}.ubam.umi.extracted.aligned.grouped.umicalled.mapped.realigned.filtered.bam
    QUALITY_DIST=$WORKING_DIR/data/$SAMPLE_ID/$SAMPLE_NAME/$CONSENSUS/${SAMPLE_NAME}.ubam.umi.extracted.aligned.grouped.umicalled.mapped.realigned.BQSR.quality.txt
    QUALITY_DISTPDF=$WORKING_DIR/data/$SAMPLE_ID/$SAMPLE_NAME/$CONSENSUS/${SAMPLE_NAME}.ubam.umi.extracted.aligned.grouped.umicalled.mapped.realigned.BQSR.quality.pdf
    QUALITY_DIST2=$WORKING_DIR/data/$SAMPLE_ID/$SAMPLE_NAME/$CONSENSUS/${SAMPLE_NAME}.ubam.umi.extracted.aligned.grouped.umicalled.mapped.realigned.BQSR.quality2.txt
    QUALITY_DISTPDF2=$WORKING_DIR/data/$SAMPLE_ID/$SAMPLE_NAME/$CONSENSUS/${SAMPLE_NAME}.ubam.umi.extracted.aligned.grouped.umicalled.mapped.realigned.BQSR.quality2.pdf
    FGBIO_CALLDUPLEXCONSENSUS_GROUPED_OUT_FILTERED_METRICS=$WORKING_DIR/data/$SAMPLE_ID/$SAMPLE_NAME/$CONSENSUS/${SAMPLE_NAME}.ubam.umi.extracted.aligned.grouped.umicalled.mapped.realigned.filtered.txt
    GATK_REALIGNTARGETSFILTCLIPPED=$WORKING_DIR/data/$SAMPLE_ID/$SAMPLE_NAME/$CONSENSUS/${SAMPLE_NAME}.ubam.umi.extracted.aligned.grouped.umicalled.mapped.realigned.filtered.clipped.bam
    FGBIO_CALLDUPLEXCONSENSUS_GROUPED_OUT_FILTERED_CLIPPED_METRICS=$WORKING_DIR/data/$SAMPLE_ID/$SAMPLE_NAME/$CONSENSUS/${SAMPLE_NAME}.ubam.umi.extracted.aligned.grouped.umicalled.mapped.realigned.filtered.clipped.txt
    VARIANTS_CALLED=$WORKING_DIR/data/$SAMPLE_ID/$SAMPLE_NAME/$CONSENSUS/${SAMPLE_NAME}.variants.vcf.gz
    VARIANTS_CALLED_TABLE=$WORKING_DIR/data/$SAMPLE_ID/$SAMPLE_NAME/$CONSENSUS/${SAMPLE_NAME}.variants.table
    READS_PRINTED=$WORKING_DIR/data/$SAMPLE_ID/$SAMPLE_NAME/$CONSENSUS/${SAMPLE_NAME}.READS_PRINTED.txt
    FINAL_CALLS=$WORKING_DIR/data/$SAMPLE_ID/$SAMPLE_NAME/$CONSENSUS/${SAMPLE_NAME}.haplo.vcf.gz
    FINAL_CALLS_TABLE=$WORKING_DIR/data/$SAMPLE_ID/$SAMPLE_NAME/$CONSENSUS/${SAMPLE_NAME}.haplo.table
    PONPATH=$WORKING_DIR/data/PON.xlsx
    ENUM_VCF=$WORKING_DIR/data/$SAMPLE_ID/$SAMPLE_NAME/$CONSENSUS/${SAMPLE_NAME}.enum.${CONSENSUS}.updated.vcf
    ENUM_BCF=$WORKING_DIR/data/$SAMPLE_ID/$SAMPLE_NAME/$CONSENSUS/${SAMPLE_NAME}.enum.${CONSENSUS}.bcf
    ENUM_BCF_INDEX=$WORKING_DIR/data/$SAMPLE_ID/$SAMPLE_NAME/$CONSENSUS/${SAMPLE_NAME}.enum.${CONSENSUS}.index
    FINAL_ENUM_TABLE=$WORKING_DIR/data/$SAMPLE_ID/$SAMPLE_NAME/$CONSENSUS/${SAMPLE_NAME}.enum.filt.${CONSENSUS}.updated.table
    ENUM_FILT_VCF=$WORKING_DIR/data/$SAMPLE_ID/$SAMPLE_NAME/$CONSENSUS/${SAMPLE_NAME}.enum.filt.${CONSENSUS}.updated.vcf
    FASTQC_OUT=$WORKING_DIR/data/$SAMPLE_ID/$SAMPLE_NAME
    VARDICT_CALLS=$WORKING_DIR/data/$SAMPLE_ID/$SAMPLE_NAME/$CONSENSUS/${SAMPLE_NAME}.vardict.table
    BQSR_TABLE=$WORKING_DIR/data/$SAMPLE_ID/$SAMPLE_NAME/$CONSENSUS/${SAMPLE_NAME}.ubam.umi.extracted.aligned.grouped.umicalled.mapped.realigned.filtered.clipped.bqsr.table
    BQSR_BAM=$WORKING_DIR/data/$SAMPLE_ID/$SAMPLE_NAME/$CONSENSUS/${SAMPLE_NAME}.ubam.umi.extracted.aligned.grouped.umicalled.mapped.realigned.filtered.clipped.bqsr.bam
    VARDICT_CALLS_TABLE=$WORKING_DIR/data/$SAMPLE_ID/$SAMPLE_NAME/$CONSENSUS/${SAMPLE_NAME}_vardict.table
    ...
    PANEL=$WORKING_DIR/data/pan00309.merged.baits.hs38DH.bed
    #PANEL=$WORKING_DIR/data/pan00309.targets.hs38DH.bed
    ...
    # # # Trim
    # # # java -jar $PWD/bnsugg/programs/Trimmomatic-0.39/trimmomatic-0.39.jar PE -phred33 \
    # # # $WORKING_DIR/data/$SAMPLE_ID/U266Pos_R1.downsampled10.fastq $WORKING_DIR/data/$SAMPLE_ID/U266Pos_R1.downsampled10.fastq \
    # # # $WORKING_DIR/data/$SAMPLE_ID/${SAMPLE_ID_R1}_P.fastq.gz $WORKING_DIR/data/$SAMPLE_ID/${SAMPLE_ID_R1}_U.fastq.gz \
    # # # $WORKING_DIR/data/$SAMPLE_ID/${SAMPLE_ID_R2}_P.fastq.gz $WORKING_DIR/data/$SAMPLE_ID/${SAMPLE_ID_R2}_U.fastq.gz \
    # # # ILLUMINACLIP:$PWD/bnsugg/programs/Trimmomatic-0.39/adapters/TruSeq3-PE-2.fa:2:30:10 LEADING:3 TRAILING:3 SLIDINGWINDOW:4:15 MINLEN:36

    # # # Downsample
    # # # seqtk sample -s100 $WORKING_DIR/data/$Project/FASTQ/U266Pos_R1.fastq.gz .001 > $WORKING_DIR/data/$SAMPLE_ID/U266Pos_R1.downsampled10.fastq
    # # # seqtk sample -s100 $WORKING_DIR/data/$Project/FASTQ/U266Pos_R2.fastq.gz .001 > $WORKING_DIR/data/$SAMPLE_ID/U266Pos_R2.downsampled10.fastq
    ...
    if test -f "$GATK_REALIGNTARGETSFILT"; then
        ...
        rm -f "$FGBIO_FASTQTOBAM_EXTRACTED_OUT"
        rm -f "$PICARD_SAMTOFASTQ_OUT"
        rm -f "$PICARD_SAMTOFASTQ_CALLDUPLEXCONSENSUS_MAPPED_OUT"
    fi
    ...
    if test -f "$BQSR_BAM"; then
        ...
        I=$GATK_REALIGNTARGETSFILTCLIPPED \
        O=$FGBIO_CALLDUPLEXCONSENSUS_GROUPED_OUT_FILTERED_CLIPPED_METRICS \
    ...
    if test -f "$FINAL_ENUM_TABLE"; then
